...
export default function HeroSlide() {
    ...
    return (
        <div id='hero' className='w-3/4 mx-auto   mb-5'>
            <Slider {...settings}>
                <div className='p-2'>
                    <img src={image[0]} className=' rounded' />
                </div>
                <div className='p-2'>
                    <img src={image[1]} className='rounded' />
                </div>
                <div className='p-2'>
                    <img src={image[2]} className='rounded' />
                </div>
                <div className='p-2'>
                    <img src={image[3]} className='rounded' />
                </div>
            </Slider>
        </div>
    );
